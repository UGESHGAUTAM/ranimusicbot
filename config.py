...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/UGESHGAUTAM/ranimusicbot",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/BOT_X_HUB_YADAV")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/friends_kiDuniya")
